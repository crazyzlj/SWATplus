...
30      cell_num_hrus(cell_row,cell_col) = hru_count
      ...
      write(out_gwbal,*)
      gwflow_hdr_day = (/character(13)::"  year","   day","ts","vol_bef","vol_aft","rech","gwet","gwsw","swgw","satex","gwsoil", &
      ...
      write(out_gwbal_yr,*)
      gwflow_hdr_yr = (/character(13)::"  year","delvol","rech","gwet","gwsw","swgw","satex","gwsoil","bound","pump_ag","pump_ex","tile","lake"/)
      ...
      write(out_gwbal_aa,*)
      gwflow_hdr_aa = (/character(13)::"  year","delvol","rech","gwet","gwsw","swgw","satex","gwsoil","bound","pump_ag","pump_ex","tile","lake"/)
      ...
      if(gw_transport_flag.eq.1) then
        ...
        write(out_gwbaln,*)
        gwflown_hdr_day = (/character(13)::"  year","   day","ts","massbef","massaft","rech","gwsw","swgw","satex","gwsoil","adv","dsp","rct", &
        ...
        write(out_gwbalp,*)
        gwflowp_hdr_day = (/character(13)::"  year","   day","ts","massbef","massaft","rech","gwsw","swgw","satex","gwsoil","adv","dsp","rct", &
                            "pump_ag","pump_ex","tile","lake","error"/)
        ...
        write(out_gwbaln_yr,*)
        gwflown_hdr_yr = (/character(13)::"  year","delmass","rech","gwsw","swgw","satex","gwsoil","adv","dsp","rct","pump_ag","pump_ex","tile","lake"/)
        ...
        write(out_gwbalp_yr,*)
        gwflowp_hdr_yr = (/character(13)::"  year","delmass","rech","gwsw","swgw","satex","gwsoil","adv","dsp","rct","pump_ag","pump_ex","tile","lake"/)
        ...
        write(out_gwbaln_aa,*)
        gwflown_hdr_aa = (/character(13)::"  year","delmass","rech","gwsw","swgw","satex","gwsoil","adv","dsp","rct","pump_ag","pump_ex","tile","lake"/)
        ...
        write(out_gwbalp_aa,*)
        gwflowp_hdr_aa = (/character(13)::"  year","delmass","rech","gwsw","swgw","satex","gwsoil","adv","dsp","rct","pump_ag","pump_ex","tile","lake"/)
      ...
      write(out_hyd_sep,*)
      hydsep_hdr = (/character(16)::"  year","   day","channel","chan_surf","chan_lat","chan_gwsw","chan_swgw","chan_satexgw","chan_satexsw","chan_tile"/)
