##
# crazyzlj/swatplus:alpine
#
# Usage: 
#   > cd SWATplus
#   > docker build -t <tag> -f docker/Dockerfile .
#   or build and push for amd64 and arm64 platforms simultanously
#   > docker buildx build --platform linux/amd64,linux/arm64 --push -t crazyzlj/swatplus:alpine -f docker/Dockerfile .
#
